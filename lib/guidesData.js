import { 
  ...
  Smartphone, Briefcase, Monitor, EyeOff, Calculator
} from 'lucide-react';
...
export const guidesData = [
  ...
  },
  {
    ...
    excerpt: "Guía práctica para implementar el minimalismo digital. Elimina distracciones, recupera horas de tu día y construye una relación intencional con la tecnología.",
    icon: Smartphone,
    color: "slate",
  ...
  },
  {
    ...
    excerpt: "Descubre cómo los alimentos impactan la inflamación sistémica. Aprende a diseñar una dieta que optimice tu energía y prevenga enfermedades crónicas.",
    icon: Utensils,
    color: "green",
  ...
  },
  {
    ...
    excerpt: "Estrategias probadas para negociar tu salario, aumentos y beneficios. Supera el síndrome del impostor y usa datos para respaldar tu valor.",
    icon: Briefcase,
    color: "emerald",
  ...
  {
    title: "IA para Creativos y Diseñadores",
    slug: "ia-para-creativos",
    excerpt: "Cómo integrar herramientas generativas en tu flujo de trabajo creativo sin perder tu estilo único. De Midjourney a la automatización de tareas.",
    icon: Sparkles,
    color: "violet",
  ...
  },
  {
    ...
    excerpt: "Técnicas de atención plena que puedes aplicar en 5 minutos al día. Reduce el estrés y mejora tu enfoque sin tener que meditar por horas.",
    icon: Brain,
    color: "teal",
  ...
  {
    title: "Diseño de Espacios de Trabajo",
    slug: "espacios-trabajo-productivos",
    excerpt: "Optimiza tu entorno físico para el trabajo profundo. Iluminación, ergonomía, acústica y psicología del color para tu home office.",
    icon: Monitor,
    color: "blue",
  ...
  },
  {
    ...
    excerpt: "Audita y protege tus perfiles sociales. Descubre qué datos están recolectando sobre ti y cómo limitar tu exposición digital.",
    icon: EyeOff,
    color: "red",
  ...
  {
    title: "Gestión de Impuestos Freelance",
    slug: "impuestos-freelance",
    excerpt: "Deja de perder dinero en impuestos. Guía completa para profesionales independientes sobre deducciones, facturación y organización fiscal.",
    icon: Calculator,
    color: "orange",
