...
export const metadata = {
 ...
 openGraph: {
 title: "Ingeniería de Prompts Maestro: Manual de Programación Cognitiva (2026)",
 description: "Domina el lenguaje de la nueva computación. La tutorial exhaustivo para extraer el máximo rendimiento de los modelos de inteligencia artificial.",
...
export default function GuiaPrompts() {
 ...
 description: 'Guía completa sobre ingeniería de instrucciones, estrategias de razonamiento para LLMs, seguridad de prompts y optimización algorítmica de la comunicación con IA.',
 author: { '@type': 'Person', name: 'Nestor Abanto Huaman' },
 publisher: { '@type': 'Organization', name: 'AldiaDeTodo' },
 datePublished: '2026-04-19', dateModified: '2026-05-21',
