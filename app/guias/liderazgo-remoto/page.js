...
export const metadata = {
  ...
  openGraph: {
    title: "Liderazgo Remoto Maestro: Equipos Distribuidos de Alto Impacto (2026)",
    description: "Lidera sin fronteras. La guía enciclopédica definitiva para managers y líderes que buscan escala, autonomía y rendimiento en la era del trabajo distribuido.",
...
export default function GuiaLiderazgoRemoto() {
  const jsonLd = {
    ...
    description: 'Manual enciclopédico sobre gestión de equipos remotos, comunicación asíncrona, cultura organizacional distribuida y gestión por resultados OKR.',
