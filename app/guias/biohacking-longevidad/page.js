...
export const metadata = {
  ...
  description: "La guía enciclopédica definitiva sobre optimización biológica y extensión de la vida. De los senolíticos y la autofagia a la medicina de precisión genómica. +5,500 palabras de profundidad técnica.",
  openGraph: {
    title: "Biohacking & Longevidad Maestro: La Guía de Medicina 3.0 (2026)",
...
export default function GuiaBiohacking() {
  const jsonLd = {
    ...
    description: 'Manual enciclopédico sobre biohacking, longevidad radical, medicina de precisión, optimización mitocondrial y extensión de la salud.',
