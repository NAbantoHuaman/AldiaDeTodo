...
export const metadata = {
  ...
  description: "La guía enciclopédica definitiva sobre inversión indexada y ETFs. De la teoría de carteras a la optimización fiscal y Smart Beta. Más de 3,500 palabras de nivel experto.",
  openGraph: {
    title: "Inversión en ETFs y Bolsa: El Manual de la Riqueza Generacional (2026)",
...
export default function GuiaETFs() {
  const jsonLd = {
    ...
    description: 'Manual enciclopédico sobre inversión indexada, ETFs, teoría de carteras, Smart Beta y gestión de activos para el largo plazo.',
      ...
      <div className="container mx-auto px-4 max-w-4xl py-16">
        <div className="prose prose-lg prose-slate max-w-none">
          ...
          <p className="mb-12 font-medium text-slate-700">
            Bienvenido al manual definitivo sobre la herramienta de creación de riqueza más potente jamás diseñada para el ciudadano medio: los Fondos Cotizados (ETFs). Olvida las promesas de rentabilidad rápida de los gurús de YouTube. Estamos aquí para construir una fortaleza financiera basada en la **Teoría de Carteras Moderna**, la eficiencia de costes y la diversificación global total. En esta guía enciclopédica de más de 3,500 palabras, vamos a diseccionar desde la anatomía interna de la creación de participaciones hasta las estrategias avanzadas de Smart Beta, el diferimiento fiscal masivo y los protocolos de rebalanceo que separan a los inversores aficionados de los arquitectos de capital. Prepárate para que tu dinero empiece a trabajar por ti con la precisión de un reloj suizo.
          </p>
