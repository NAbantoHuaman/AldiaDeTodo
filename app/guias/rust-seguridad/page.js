...
export const metadata = {
 ...
 openGraph: {
 title: "Rust Maestro: Seguridad de Memoria y Rendimiento de Élite (2026)",
 description: "Domina el lenguaje que está redefiniendo la ingeniería de sistemas. La guía detallada para desarrolladores que buscan seguridad total sin comprometer la velocidad.",
...
export default function GuiaRust() {
 ...
 description: 'Guía completa sobre Rust, sistemas de bajo nivel, seguridad de memoria garantizada (Memory Safety), concurrencia moderna y WebAssembly.',
