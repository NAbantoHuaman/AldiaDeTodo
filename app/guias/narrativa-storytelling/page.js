...
export const metadata = {
 ...
 openGraph: {
 title: "Narrativa y Storytelling Maestro: El Superpoder de la Influencia (2026)",
 description: "Domina la herramienta más poderosa de la humanidad. La guía paso a paso para líderes, creativos y oradores en la era de la distracción digital.",
...
export default function GuiaStorytelling() {
 ...
 description: 'Guía completa sobre arte narrativo, estructuras de historias, psicología de la audiencia, storytelling de negocios y técnicas de persuasión emocional.',
