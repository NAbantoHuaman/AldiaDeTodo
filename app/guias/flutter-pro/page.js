...
export const metadata = {
  ...
  description: "La guía enciclopédica definitiva sobre Flutter y Dart. Del motor Impeller a arquitecturas Clean y despliegue corporativo. Más de 3,500 palabras de ingeniería móvil.",
  openGraph: {
    title: "Flutter Pro: El Manual del Maestro Multiplataforma (2026)",
...
export default function GuiaFlutter() {
  const jsonLd = {
    ...
    description: 'Manual enciclopédico sobre el desarrollo móvil y multiplataforma usando Flutter, Dart 4.0, Impeller y arquitecturas reactivas avanzadas.',
