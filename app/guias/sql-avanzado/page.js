...
export const metadata = {
  ...
  description: "La guía enciclopédica definitiva sobre SQL avanzado y PostgreSQL. De Window Functions y CTEs recursivas a índices GIN/BRIN, MVCC y vectores de IA. +3,500 palabras.",
  openGraph: {
    title: "SQL Moderno Maestro: El Manual de la Verdad de Datos (2026)",
  ...
  const jsonLd = [
    {
      ...
      description: 'Manual enciclopédico sobre SQL avanzado, modelado de datos, optimización de PostgreSQL y arquitecturas de datos distribuidas.',
