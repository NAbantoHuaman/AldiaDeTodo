...
export const metadata = {
  ...
  openGraph: {
    title: "Entrenamiento de Fuerza Maestro: Ciencia, Salud y Longevidad (2026)",
    description: "Crea tu armadura biológica. La guía enciclopédica definitiva para atletas y entusiastas que buscan fuerza máxima y salud metabólica integral.",
...
export default function GuiaFuerza() {
  const jsonLd = {
    ...
    description: 'Manual enciclopédico sobre entrenamiento de fuerza, hipertrofia muscular, biomecánica del ejercicio, periodización y salud metabólica.',
      ...
      <div className="bg-gradient-to-b from-teal-50 to-white py-24 border-b border-teal-100">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 text-sm text-slate-500 font-medium">
            ...
            <span className="flex items-center gap-2 bg-white shadow-sm border border-slate-100 px-4 py-2 rounded-xl text-slate-900"><BookOpen className="w-4 h-4 text-teal-500" /> +3500 Palabras</span>
