  ...
  const jsonLd = [
    ...
    },
    {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: '¿Debo ahorrar o pagar deudas primero?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Si tus deudas tienen un interés mayor al 10% (como tarjetas de crédito), págalas agresivamente. Si tienen interés bajo (hipoteca), puedes ahorrar e invertir simultáneamente.'
          }
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'En 2026, puedes empezar con montos muy pequeños gracias a las apps de inversión fraccionada. Lo más importante es el hábito de aportar todos los meses.'
          }
        },
        {
          '@type': 'Question',
          name: '¿Qué es el Lifestyle Creep?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Es la tendencia a aumentar tus gastos a medida que aumentan tus ingresos. La clave para la libertad financiera es mantener tus gastos estables mientras tus ingresos suben.'
          }
        }
      ]
    }
        ...
        <div className="prose prose-lg prose-slate max-w-none text-slate-900">
          ...
          <div id="faq" className="mt-24 pt-16 border-t border-slate-200">
            ...
            <div className="space-y-6">
              ...
              <details className="group bg-slate-50 rounded-2xl border border-slate-200 p-6 [&_summary::-webkit-details-marker]:hidden">
                <summary className="flex items-center justify-between cursor-pointer list-none">
                  <h4 className="text-lg font-bold text-slate-900 m-0">¿Cuánto dinero necesito para empezar a invertir?</h4>
                  <span className="transition-transform group-open:rotate-180">
                    <ChevronLeft className="w-5 h-5 -rotate-90" />
                  </span>
                </summary>
