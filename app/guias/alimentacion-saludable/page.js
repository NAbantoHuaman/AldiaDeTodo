...
export const metadata = {
  ...
  description: "La guía enciclopédica definitiva sobre nutrición humana. +5,500 palabras sobre bioquímica metabólica, nutrigenómica, toxicología alimentaria y optimización del microbioma.",
  openGraph: {
    title: "Alimentación Saludable Maestro: El Manual de la Bio-Ingeniería Nutricional (2026)",
...
export default function GuiaAlimentacion() {
  const jsonLd = {
    ...
    description: 'Manual enciclopédico sobre nutrición humana, bioquímica, microbiota, nutrigenómica y salud metabólica integral.',
      ...
      <div className="container mx-auto px-4 max-w-4xl py-16">
        <div className="prose prose-lg prose-slate max-w-none">
          ...
          <section className="mb-24">
            ...
            <p>
              Comprenderás por qué el azúcar refinado actuá como un interruptor de envejecimiento acelerado; por qué las grasas de calidad son el material estructural de tus neuronas; y cómo el cronometraje de tus ingestas (Crononutrición) es casi tan impactante como el perfil nutricional de las mismas. Prepárate para rehabilitar tu relación con la alimentación desde la ciencia más robusta y desaprender décadas de dogmas obsoletos.
            </p>
          </section>
