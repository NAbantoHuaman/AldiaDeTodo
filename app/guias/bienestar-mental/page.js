...
export const metadata = {
  ...
  description: "La guía enciclopédica definitiva sobre salud mental y neurobiología. +5,500 palabras de profundidad técnica sobre PNI, Teoría Polivagal y Soberanía Cognitiva.",
  openGraph: {
    title: "Soberanía Mental Maestro: El Manual de la Resiliencia Radical (2026)",
...
export default function GuiaBienestar() {
  const jsonLd = {
    ...
    description: 'Manual enciclopédico sobre salud mental, neurociencia, teoría polivagal, psico-neuro-inmunología (PNI) y estrategias de bienestar avanzado.',
