...
export const metadata = {
  ...
  description: "La guía enciclopédica definitiva sobre TypeScript avanzado. De la programación a nivel de tipos a arquitecturas de monorepos. Más de 3,500 palabras de sabiduría técnica.",
  openGraph: {
    title: "TypeScript Maestro: El Manual de la Ingeniería de Tipos (2026)",
  ...
  const jsonLd = [
    {
      ...
      description: 'Manual enciclopédico sobre TypeScript avanzado, programación a nivel de tipos, genéricos complejos y arquitecturas robustas.',
