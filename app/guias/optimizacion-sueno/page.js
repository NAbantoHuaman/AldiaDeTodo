...
export default function GuiaSueno() {
  const jsonLd = {
    ...
    description: 'Manual enciclopédico sobre arquitectura del sueño, higiene circadiana, sistema glinfático y suplementación para el descanso profundo.',
    ...
    <article className="min-h-screen bg-white font-inter text-slate-900">
      ...
      <div className="bg-gradient-to-b from-slate-100 to-white py-24 border-b border-slate-200">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 text-sm text-slate-500 font-medium">
            ...
            <span className="flex items-center gap-2 bg-white shadow-sm border border-slate-100 px-4 py-2 rounded-xl text-slate-900"><BookOpen className="w-4 h-4 text-slate-500" /> +3500 Palabras</span>
      ...
      <div className="container mx-auto px-4 max-w-4xl py-16">
        <div className="prose prose-lg prose-slate max-w-none">
          ...
          <p>
             Olvida los somníferos químicos que te sedan pero no te dan sueño real. El stack de optimización se basa en:
